                    ...
                    <div class="card">
                        <a href="blog.jsp">
                            <div class="card-image">
                                <img src=<c:out value="${article.get('backgroundImg')}"></c:out> class="responsive-img" alt="一行Python指令实现文件共享">
                                <span class="card-title"><c:out value="${article.get('title')}"></c:out></span>
                            </div>
                        </a>
                  ...
                  <a href="categories.jsp" class="post-category">
                    <c:out value="${article.get('catName')}"></c:out>
                        ...
                        <div class="card-action article-tags">
                            <a href="tags.jsp">
                                <span class="chip bg-color"><c:out value="${article.get('tagName')}"></c:out></span>
                            </a>
                        </div>
                    </div>
                </div>

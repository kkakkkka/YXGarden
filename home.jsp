				...
				<div class="card">
					<div class="card-content">
						<div class="dream">
							...
							<div class="row">
								<div
									class="col l8 offset-l2 m10 offset-m1 s10 offset-s1 center-align text">
			...
			<div class="row article-row">
				...
				<c:forEach items="${articles}" var="article">
					<div class="article col s12 m6 l4 myaos">
						<div class="card">
							<a
								href="blog.jsp?blogID=<c:out
											value="${article.get('blogID')}"></c:out>">
								<div class="card-image">
									<img
										src=<c:out value="${article.get('backgroundImg')}"></c:out>
										class="responsive-img"
										alt=<c:out value="${article.get('title')}"></c:out>> <span
										class="card-title"><c:out
							...
							<div class="card-action article-tags" style="position: relative;">
								...
								</a> <img src="./medias/trash.png" onclick=delBlog(
									<c:out value="${article.get('blogID')}"></c:out> )

        ...
        <div class="container archive-calendar">
            <div class="card">
                <div class="date-line1">
                    本站已经有<a class="date-number0"><%=userCnt%></a>名用户发布了<a class="date-number1"><%=blogCnt%></a>篇文章~
                </div>
                <div class="date-line2">
                    其中，你一共贡献了<a class="date-number3"><%=myCnt%></a>篇文章!<br> 继续加油吧~~
                </div>
            </div>
        </div>
                        ...
                        <div class="card">
                            <a href="blog.jsp?blogID=<%=blogIDList.get(j)%>">
                                <div class="card-image">
                                    ...
                                    %>
                                    <%-- <img src="./<%bkList.get(j)%>" class="responsive-img" alt="<%=titleList.get(j)%>"> --%>
    ...
    <div class="container paging">
        <div class="row">
            ...
            <div class="page-info col m4 l4 hide-on-small-only">
                <div class="center-align b-text-gray"><%=nowPage%> / <%=pages%></div>
            </div>
            <div class="col s6 m4 l4">
                <%

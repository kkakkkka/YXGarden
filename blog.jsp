                                                ...
                                                <div id="navContainer" class="nav-wrapper container">
                                                    <div class="brand-logo">
                                                        ...
                                                        <div id="login_to_change" style="display: inline;">
                                                            <span class="logo-span" style="position: relative; bottom: 24px; left: 5px"> <c:out
								...
								<div class="reprint__notice">
									<span class="reprint-meta" style="font-weight: bold;"> <i
										...
										rel="external nofollow noreferrer" target="_blank">CC BY
											4.0</a> 许可协议。转载请注明来源 <a href="about.jsp" target="_blank"><c:out
												value="${article.get('userName')}"></c:out></a> !
									</span>
                                                                </div>
                                    ...
                                    <footer class="page-footer bg-color">
                                    	...
                                    	<button type='button'  onclick="likeit(<%out.print(userID); %>, <%out.print(blogID); %>)"> <img src="./medias/thumb.png" style="width: 37px; height: 37px; position: fixed; bottom: 108px; right: 11px;"></button>
                                        ...
                                        <div class="container row center-align" style="margin-bottom: 15px !important;">
                                            <div class="s12 copy-right">
                                                Copyright&nbsp;&copy; <span id="year">2022</span> <a href="about.jsp" target="_blank">逸仙苑</a> |&nbsp;Powered by&nbsp;<a href="https://www.sysu.edu.cn/" target="_blank">SYSU</a> |&nbsp;Organization&nbsp;
                                                <a href="https://cse.sysu.edu.cn/" target="_blank">CSE</a> <br>
                                            </div>
                                        </div>
                                    </footer>
                                </body>
